...
class PasswordManager:
    def __init__(self):
        ...
        self.requirements = Label(self.root,
                                  text="Password Requirements: At least 8 characters, contains letters and numbers.")
        ...
        self.password_listbox = Listbox(self.root)
        self.password_listbox.grid(row=4, column=0, columnspan=2)
        ...
        self.store_button.grid(row=5, column=1)
    ...
    def delete_password(self):
        site = self.password_listbox.get(ANCHOR)
        if site:
        ...
        if file_path:
            try:
                with open(file_path, "r") as file:
                    ...
                    self.passwords = {site: base64.b64decode(encrypted_password) for site, encrypted_password in
    ...
    def export_passwords(self):
        ...
        if file_path:
            try:
                passwords_to_export = {site: base64.b64encode(encrypted_password).decode() for site, encrypted_password
                                       in self.passwords.items()}
